...
> Дата: 2026-06-14 (полный пересмотр)
> Состояние кодбазы: скелет 3D-движка на OpenGL 3.3 + SDL3 + ImGui
...
> Строк кода (проект): ~3 500 (без 3rdparty)
...
|------|--------|-------------|
| `README.MD` | Пуст | Нужно заполнить |
| `ROADMAP.MD` | Пуст | Заполнить поэтапным планом (см. секцию EoB выше) |
| `TODO.md` | Не существует | Создать |
| `src/Game.vcxproj:230` | ⚠ `engine/renderer/aabb.h` | Не существует — удалить строку |
